...
const press = document.querySelector('.sidebar-item__press');
...
const input = document.querySelector('.label-check');
const sendBtn = document.querySelector('.popup-order .button--send');
